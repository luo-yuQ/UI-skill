...
- Keep composition, camera angle, subject placement, perspective layout, page layout, and element positions out of `style_candidates`. They may remain in factual `visual_description` or, when image-specific, `content_specific_traits`.
- Restrict Material Language to tangible objects and surface appearance. Record fire, smoke, fog, glow, magical light, particles, and sparks as lighting, decoration/effects, atmosphere, or visible content instead.
